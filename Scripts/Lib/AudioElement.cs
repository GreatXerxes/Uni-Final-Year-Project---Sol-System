...
public class AudioElement
{
    ...
    public AudioElement(List<AudioClip> sounds, List<float> volumes, string id, Transform parentTransform)
    {
        ...
        element = new GameObject("AudioElement_" + id);//creates a new audio game object that plays when created
    ...
    public void Add(List<AudioClip> sounds, List<float> volumes)//adds the audio to an existing object
    {
    ...
    public void Play(AudioClip sound)//plays it
    {
        GameObject temp;
    ...
    public void Pause(AudioClip sound)//pauses the audio
    {
        GameObject temp;
        if (soundObjects.TryGetValue(sound, out temp))
        {
    ...
    public void Stop(AudioClip sound)//stops the audio
    {
        GameObject temp;
        if (soundObjects.TryGetValue(sound, out temp))
        {
    ...
    public bool IsPlaying(AudioClip sound)//checks if it is playing
    {
        GameObject temp;
        if (soundObjects.TryGetValue(sound, out temp))
        {
